...
class LMPOTrainer(Trainer):
    r"""
    Initialize LMPOTrainer.
    ...
    def lmpo_loss(
        ...
        self.z_normalization(margin)
        margin_normalized = (margin - self.a) / self.b
        margin_scaled = self.lambda_c * margin_normalized
