...
class SimPOTrainer(DPOTrainer):
    ...
    def __init__(self, **kwargs):
        ...
        self.running1 = RunningMoments(self.accelerator)
        self.running2 = RunningMoments(self.accelerator)
    ...
    def simpo_loss(
        ...
        gap =  self.beta * (policy_chosen_logps - policy_rejected_logps) -  self.alpha * margin
        self.home = math.exp(self.gamma)
        # self.draw = math.sqrt(2.0)
    ...
    def concatenated_forward(
        ...
        # self.gamma = 0.02
        # self.running1.update(chosen_length)
        # mean1 = self.running1.mean
        # std1 = self.running1.std
        # chosen_length_norm = (chosen_length - mean1) / std1

        # self.running2.update(rejected_length)
        # mean2 = self.running2.mean
        # std2 = self.running2.std
        # rejected_length_norm = (rejected_length - mean2) / std2


        # print(chosen_length_norm)
        # print(rejected_length_norm)

        # length_dis = chosen_length_norm - rejected_length_norm
